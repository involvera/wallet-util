...
import { sha224, sha256 } from '../../src/sha256'

var BUFFER: any = undefined;
var JS_SHA256_NO_ARRAY_BUFFER: any = undefined;
...
const main = () => {
    ...
    function runTestCases(name: any, algorithm: any) {
      var methods = [
        {
          name: name,
          call: algorithm,
      ...
      describe(name, function () {
        methods.forEach(function (method: any) {
          describe('#' + method.name, function () {
            for (var testCaseName in subTestCases) {
              (function (testCaseName: any) {
                var testCase = subTestCases[testCaseName];
                context('when ' + testCaseName, function () {
                  for (var hash in testCase) {
                    (function (message: any, hash: any) {
                      it('should be equal', function () {
                        expect(method.call(message)).to.eq(hash);
                      });
                    })(testCase[hash], hash);
                  }
                });
        ...
        classMethods.forEach(function (method: any) {
          describe('#' + method.name, function () {
            for (var testCaseName in subTestCases) {
              (function (testCaseName: any) {
                var testCase = subTestCases[testCaseName];
          ...
          errorTestCases.forEach(function (testCase) {
            context('when ' + testCase, function () {
              it('should throw error', function () {
                expect(function () {
                  algorithm(testCase);
                }).to.throw(/input is invalid type/);
              });
            });
          });
