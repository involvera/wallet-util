import { assertEquals, assertThrows } from 'https://deno.land/std@0.146.0/testing/asserts';
import { decode } from 'https://deno.land/std/encoding/hex';
...
import { base58, base58xmr, utils } from '../';
